              ...
              <AnimatePresence initial={false} custom={direction} mode="popLayout">
                ...
                >
                  ...
                  <div className="px-2 lg:px-0 mb-4 lg:mb-8">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-2 gap-2 sm:gap-4 justify-items-center lg:hidden">
                      {productData[currentSlide].slice(0, 4).map((product) => (
                        <div
                          key={product.id}
                          className="rounded-2xl p-2 w-full sm:max-w-[250px] relative group cursor-pointer"
                        ...
                        >
                          ...
                          <div className="text-center">
                            <h4 className="font-bold text-black text-xs sm:text-sm mb-1 font-['Montserrat'] leading-tight">
                              {product.name}
                            </h4>
                            <p className="text-gray-600 text-xs sm:text-sm font-['Krona_One']">
                              {product.code}
                            </p>
                          </div>
                        </div>
                    ...
                    <div className="hidden lg:grid lg:grid-cols-4 lg:gap-8 justify-items-center">
                      {productData[currentSlide].slice(0, 4).map((product) => (
                        <div
                          key={product.id}
                  ...
                  <div className="flex justify-center px-2 lg:px-0">
                    <div className="w-full lg:max-w-[1000px]">
                      {/* Mobile & Tablet Layout - 2 columns */}
                      <div className="grid grid-cols-2 sm:grid-cols-2 gap-2 sm:gap-4 lg:hidden">
                        {productData[currentSlide].slice(4, 6).map((product) => (
                          <div
                            key={product.id}
                            className="rounded-2xl p-2 w-full sm:max-w-[250px] relative group mx-auto cursor-pointer"
                            onClick={() => handleViewClick(product)}
                          >
                            {/* View Button */}
                            <div className="absolute -top-2 right-1 z-10">
                      ...
                      {/* Last card centered on mobile & tablet */}
                      {productData[currentSlide].slice(6, 7).length > 0 && (
                        <div className="flex justify-center mt-2 sm:mt-4 mb-8 lg:mb-0 lg:hidden">
                          {productData[currentSlide].slice(6, 7).map((product) => (
                            <div
                              key={product.id}
                              className="rounded-2xl p-2 w-[calc(50%-0.25rem)] sm:max-w-[250px] relative group cursor-pointer"
                              onClick={() => handleViewClick(product)}
                            >
                              {/* View Button */}
                              <div className="absolute -top-2 -right-2 z-10">
